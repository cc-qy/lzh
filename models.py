...
class PointConvSceneFlowPWC8192selfglobalPointConv(nn.Module):
    ...
    def forward(self, xyz1, xyz2, color1, color2):
        ...
        #l2
        up_flow2 = self.upsample(pc1_l2, pc1_l3, self.scale * flow3[:,0:3])
        ...
        #l1
        up_flow1 = self.upsample(pc1_l1, pc1_l2, self.scale * flow2[:,0:3])
        ...
        #l0
        up_flow0 = self.upsample(pc1_l0, pc1_l1, self.scale * flow1[:,0:3])
        ...
        poses_t = [flow0[:,6:], flow1[:,6:], flow2[:,6:], flow3[:,6:]]
        ...
        return flows,poses_r,poses_t,fps_pc1_idxs, fps_pc2_idxs, pc1, pc2
